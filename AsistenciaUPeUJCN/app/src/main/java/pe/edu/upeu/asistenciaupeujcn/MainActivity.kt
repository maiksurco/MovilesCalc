...
import pe.edu.upeu.asistenciaupeujcn.ui.navigation.Navigation
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val colorScheme=when(themeType.value){ThemeType.PURPLE->{if (darkTheme.value) DarkPurpleColors
                else
                    LightPurpleColors}ThemeType.RED->{if (darkTheme.value) DarkRedColors else
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
           ...
           navController =
            ...
            Navigation(navController, darkMode, modif= it
            )
        }
    }
